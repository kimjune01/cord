...
def build_agent_prompt(db: CordDB, node_id: str) -> str:
    ...
    parts.append("- spawn(goal, prompt, returns, blocked_by): Create a child task")
    parts.append("- fork(goal, prompt, returns, blocked_by): Create a child that inherits context")
